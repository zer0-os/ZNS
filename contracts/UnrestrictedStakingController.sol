...
contract UnrestrictedStakingController is
  Initializable,
  ContextUpgradeable,
  ERC165Upgradeable,
  ...
  IStakingController
{
   ...
   * @param uri is the uri to a JSON object which will have more details about the request (for ui)
